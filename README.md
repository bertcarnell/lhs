...
- [Is there a way to check if sample obeys the Latin Hypercube Sampling
...
- [How to generate a design for a response surface with a discrete input
  random
