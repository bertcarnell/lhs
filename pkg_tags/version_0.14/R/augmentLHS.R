...
#            m is the number of additional points to augment the design with
...
#   B can contain more filled cells than m unless m = 2N, in which case B will
...
# 8/8/2016
#   Fixed a bug returning NA values
#
################################################################################
