...
header_vec <- c("Actions", "Code Coverage", "Website", "Doxygen", "CRAN Downloads", "CRAN")
badge_vec <- c(
  "[![R build status](https://github.com/bertcarnell/lhs/workflows/R-CMD-check/badge.svg)](https://github.com/bertcarnell/lhs/actions)",
...
badge_vec <- c(
  "[![name status badge](https://bertcarnell.r-universe.dev/badges/:name)](https://bertcarnell.r-universe.dev/)",
	...
	"[![Static Badge](https://img.shields.io/badge/DOI-10.32614%2FCRAN.package.lhs-blue)](https://cran.r-project.org/package=lhs)"  
)
...
Create a sliced design where each slice is a Latin hypercube and the union is a Latin hypercube:
