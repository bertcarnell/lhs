...
cat(paste0("|<sub>", 
           paste0(
             c("Actions", "Code Coverage", "Website", "Doxygen", "CRAN Downloads", "CRAN", "DOI"), 
             collapse="</sub>|<sub>"), 
           "</sub>|\n"))
...
cat(paste0("|", 
           paste0(c("[![R build status](https://github.com/bertcarnell/lhs/workflows/R-CMD-check/badge.svg)](https://github.com/bertcarnell/lhs/actions)",
					...
					"[![](https://zenodo.org/badge/DOI/10.5281/zenodo.19656143.svg)](https://doi.org/10.5281/zenodo.10685575)")
                  collapse="|"), 
           "|"))
