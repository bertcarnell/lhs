...
cat(paste0("|<sub>", 
           paste0(
             c("Actions", "Windows", "Code Coverage", "Website", "Doxygen", "CRAN Downloads", "CRAN"), 
             collapse="</sub>|<sub>"), 
           "</sub>|\n"))
cat(paste0("|", paste0(rep(":---:", 7), collapse="|"), "|\n"))
cat(paste0("|", 
           paste0(c("[![R build status](https://github.com/bertcarnell/lhs/workflows/R-CMD-check/badge.svg)](https://github.com/bertcarnell/lhs/actions)",
                    "[![Build status](https://ci.appveyor.com/api/projects/status/5h8gjnq6a30r8y37/branch/master?svg=true)](https://ci.appveyor.com/project/bertcarnell/lhs/branch/master)",
