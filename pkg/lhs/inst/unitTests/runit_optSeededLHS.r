...
test.optSeededLHS <- function()
{
  ...
  suppressWarnings(checkException(optSeededLHS(randomLHS(10, 4), Inf), silent=TRUE))
  checkException(optSeededLHS(randomLHS(10, 4), 2, NA), silent=TRUE)
  checkException(optSeededLHS(randomLHS(10, 4), 2, NaN), silent=TRUE)
  suppressWarnings(checkException(optSeededLHS(randomLHS(10, 4), 2, Inf), silent=TRUE))
  ...
  suppressWarnings(checkException(optSeededLHS(randomLHS(10, 4), 2, 5, Inf), silent=TRUE))
